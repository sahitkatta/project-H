...
const STEPS = ['Customer Info', 'Items', 'Pricing', 'Review & Submit'];
  ...
  return (
    <div className="p-6 max-w-3xl mx-auto">
      ...
      <Card className="p-6">
        ...
        {step === 1 && (
          <div>
            <h2 className="text-lg font-semibold text-gray-900 mb-4">Select Menu Items</h2>
            {menuLoading ? (
                        ...
                        <div key={item.menu_item_id} className="flex items-center gap-3">
                          ...
                          <div className="flex items-center gap-2">
                            <button
                              ...
                              className="w-6 h-6 rounded-full bg-white border border-gray-300 text-sm flex items-center justify-center hover:bg-gray-50"
                            >
                              -
                            </button>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-gray-50 rounded-lg divide-y divide-gray-200">
              <div className="px-4 py-3">
                ...
                {form.customer_email && (
                  <p className="text-sm text-gray-600">{form.customer_email}</p>
                )}
              </div>
              <div className="px-4 py-3">
              ...
              <div className="px-4 py-3">
                ...
                <div className="flex justify-between text-sm">
                  ...
                  <span className="font-medium">
                    {formatCurrency(
                      parseFloat(form.estimated_price) || itemsTotal,
                    )}
                  </span>
                </div>
                {form.negotiated_price && (
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="font-medium text-green-600">
                      {formatCurrency(parseFloat(form.negotiated_price))}
                    </span>
                  </div>
                )}
              </div>
        ...
        <div className="flex justify-between mt-8 pt-6 border-t border-gray-100">
          <Button
            variant="secondary"
            onClick={() => (step === 0 ? navigate('/catering') : setStep(step - 1))}
          >
            {step === 0 ? 'Cancel' : 'Back'}
          </Button>
          {step < STEPS.length - 1 ? (
